 ...
 *      we want to prevent).
 *   2. List every object in the bucket under `slabplan/uploads/`.
 ...
 *   - It does not consider any prefix outside `slabplan/uploads/`.
 *
 * Usage:
 ...
 *                     under the SlabPlan uploads prefix. Defaults to
 *                     500_000 — well above any plausible SlabPlan
