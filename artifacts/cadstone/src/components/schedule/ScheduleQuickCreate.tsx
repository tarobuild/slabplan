...
export function ScheduleQuickCreate({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="p-0 gap-0 max-w-md w-full rounded-2xl shadow-2xl border border-slate-200 [&>button]:hidden">
        <DialogTitle className="sr-only">New schedule item</DialogTitle>
        ...
        <div className="px-5 pt-4 pb-5 space-y-4">
          <div className="flex items-center gap-3">
            <div
              className="size-3.5 rounded-full shrink-0 ring-2 ring-offset-1 ring-slate-200"
          ...
          <div className="flex items-center justify-between pt-1 border-t border-slate-100">
            <button
              ...
              className="text-sm font-medium text-slate-500 hover:text-orange-600 transition-colors py-1"
            >
              More options
            </button>
            <Button
