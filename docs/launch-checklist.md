...
| `SUPABASE_URL` | required for upload storage | ✅ present |
| `SUPABASE_STORAGE_BUCKET` | required for upload storage | ✅ `cadstone-files` |
| `SUPABASE_SERVICE_ROLE_KEY` | required for upload storage | ✅ present |
