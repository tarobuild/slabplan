...
const QUERY_PARAMS_BY_PATH = {
  ...
  "/dashboard/schedule": [
    { name: "start", schema: { type: "string", format: "date" }, description: "Inclusive lower bound on the schedule range (YYYY-MM-DD). Defaults to today." },
    { name: "end", schema: { type: "string", format: "date" }, description: "Inclusive upper bound on the schedule range (YYYY-MM-DD). Defaults to today + 60 days. Must be on or after `start`." },
  ],
  "/search": [
